...
I need to create one const and three var codes. I will create the HTML, CSS, and JS files and link the three. I will put them together to create the full code leaving spaces or adding commas where needed.
Now, I need to create a list for the numbers in the combination.
After the list, I need to align everything so it looks neat.
*/

const str4 = 'You have received this message because you have been chosen to open an important vault. Here is the secret combination:';
//Initial message complete
var code1 = 11-1;
var code2 = 160/4;
var code3 = 1*39;
//Three numbers based on information given
console.log(str4 + code1 + ',' + code2 + ',' + code3);
//This is displaying  the code correctly
